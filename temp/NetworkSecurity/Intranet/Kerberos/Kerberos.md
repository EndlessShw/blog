...
3. 登录的流程：
    ![本地认证流程](Kerberos.assets/本地认证流程-1685346024111-2.png)
...
4. 常用的工具：
    ...
    1. CrackMapExec
        ![image-20230530110015003](Kerberos.assets/image-20230530110015003.png)
...
4. 示例图：
    ![image-20230530145333470](Kerberos.assets/image-20230530145333470.png)
...
7. 流程图：
    ![image-20230530151354507](Kerberos.assets/image-20230530151354507.png)

### 2.9 认证的详细流程

1. 第一步：
    ![image-20230530151719299](Kerberos.assets/image-20230530151719299.png)
2. 第一步：
    ![image-20230530152017531](Kerberos.assets/image-20230530152017531.png)
    注意：
...
3. 第二步：
    ![image-20230530152630164](Kerberos.assets/image-20230530152630164.png)
...
4. Ticket 的组成：
    ![image-20230530153848781](Kerberos.assets/image-20230530153848781.png)
...
5. 第三步：
    ![image-20230530155320628](Kerberos.assets/image-20230530155320628.png)
