...
2. 运行该代码后，访问页面后结果如下：
    ![image-20230404104112980](SSRF-Java.assets/image-20230404104112980.png)
...
2. 因此，这里使用 `file` 协议来读取文件内容：
    ![image-20230404104720705](SSRF-Java.assets/image-20230404104720705.png)
...
2. 使用 `file` 协议下载：
    ![image-20230404112541362](SSRF-Java.assets/image-20230404112541362.png)
