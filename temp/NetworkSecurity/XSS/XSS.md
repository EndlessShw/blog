...
2. 结果如下：
    ...
    ![image-20220510235944048](XSS.assets/image-20220510235944048.png)
...
2. 结果如下：
    ...
    ![image-20220511000824154](XSS.assets/image-20220511000824154.png)
...
2. 结果如下：
    ...
    ![image-20220511001018711](XSS.assets/image-20220511001018711.png)
...
2. 将实体编码直接执行的标签和情况：
    ...
    1. `<svg>` ：
        ...
        ![image-20220511002151285](XSS.assets/image-20220511002151285.png)

    2. 其他标签中的属性或者事件：

        ![image-20220511002117634](XSS.assets/image-20220511002117634.png)
