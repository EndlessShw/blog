...
1. 假设有这样的一段代码：
    ...
    ### ![image-20220607194428014](Serialization-PHP.assets/image-20220607194428014.png)
...
4. 转换后的结果如下：
    ...
    ![image-20220617162348376](Serialization-PHP.assets/image-20220617162348376.png)

5. 在 burpsuite 中设置 cookie 值（url 编码），让其反序列化并在 html 代码中遍历打印（打印类时就会调用 `__toString()`），从而将 `flag.php` 显示出来。

    ![image-20220617162642514](Serialization-PHP.assets/image-20220617162642514.png)
