...
5. menu.xml：
    ...
    ![image-20220210000358061](RecyclerView.assets/image-20220210000358061.png)
...
13. item_list_view.xml（这里要记住 CardView 的一些属性）：
    ...
    ![image-20220210000921309](RecyclerView.assets/image-20220210000921309.png)
...
14. item_grid_view.xml：
    ...
    ![image-20220210001010684](RecyclerView.assets/image-20220210001010684.png)
...
6. 类似 ListView 效果（垂直标准）：
    ...
    ![image-20220210000553840](RecyclerView.assets/image-20220210000553840.png)

    类似 GridView 效果（垂直标准）：

    ![image-20220210000624441](RecyclerView.assets/image-20220210000624441.png)
...
3. item_stagger_view.xml：
    ...
    ![image-20220210000732137](RecyclerView.assets/image-20220210000732137.png)
...
6. 瀑布流效果：
    ...
    ![image-20220210001151559](RecyclerView.assets/image-20220210001151559.png)
...
1. 效果图：
    ...
    ![image-20220210001244826](RecyclerView.assets/image-20220210001244826.png)
...
3. 三种条目类型 item 的布局（不太完善）：
    ...
    1. item_type_full_image.xml：
        ...
        ![image-20220210001341946](RecyclerView.assets/image-20220210001341946.png)
    ...
    2. item_type_left_title_right_image：
        ...
        ![image-20220210001408138](RecyclerView.assets/image-20220210001408138.png)
    ...
    3. item_type_three_images.xml：
        ...
        ![image-20220210001434228](RecyclerView.assets/image-20220210001434228.png)
...
1. 效果图
    ...
    ![image-20220210001612854](RecyclerView.assets/image-20220210001612854.png)

    ![image-20220210001625042](RecyclerView.assets/image-20220210001625042.png)
...
4. 加载中和加载失败重新加载的 layout 文件---item_list_loader_more.xml：
    ...
    ![image-20220210001817787](RecyclerView.assets/image-20220210001817787.png)
...
1. 效果图
    ...
    ![image-20220210001847506](RecyclerView.assets/image-20220210001847506.png)

    ![image-20220210001857986](RecyclerView.assets/image-20220210001857986.png)

    ![image-20220210001914059](RecyclerView.assets/image-20220210001914059.png)
