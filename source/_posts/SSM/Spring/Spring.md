    ...
    public class Client {
        public static void main(String[] args) {
            ...
            /*
                ...
                2. 三个参数为：classLoader、代理类要实现的接口、InvocationHandler 的实现类
...
4. 在测试程序中需要的 `InvocationHandler` 接口的实现类：
    ```java
    package com.endlessshw.proxy.service;
    ...
    public class TimerInvocationHandler implements InvocationHandler {
        ...
        /**
         * 当代理对象调用代理方法的时候，注册在 InvocationHandler 调用处理器当中的 invoke() 方法会被调用，从而代替原来执行的方法。
         * 一般情况下这个方法中编写“增强”代码，也就是在调用原来的方法（需要在 invoke 中手动反射调用）前后增加功能
         * @param proxy 代理对象的引用，用的少
         * @param method 目标对象所执行的方法（就是实际执行的目标方法）
         * @param args 目标对象所执行方法上的实参
         * @return 返回目标方法的返回值
         * @throws Throwable
         */
        @Override
