...
1. 概述：![image-20230117110822276](JavaScript/image-20230117110822276.png)
2. Webn APIs 阶段：
...
3. DOM 树：
    ![image-20230117111857215](JavaScript/image-20230117111857215.png)
...
2. 事件发生时会在元素节点之间按照特定的顺序传播，这个传播过程即 DOM 事件流。
    ![image-20230119102134918](JavaScript/image-20230119102134918.png)
...
1. BOM 包含 DOM：
    ![image-20230119134128055](JavaScript/image-20230119134128055.png)
...
4. JS 的执行机制：
    ...
    5. ![image-20230120110750689](JavaScript/image-20230120110750689.png)
