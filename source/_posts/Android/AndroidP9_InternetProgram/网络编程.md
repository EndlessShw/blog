...
1. 方法：
    ...
    ![图片3.png](网络编程/rBsADV2pvP2AHVFGAAFTbQC7LB8027.png)
...
2. 代码实例：
    ...
    ![image-20220204104105405](网络编程/image-20220204104105405.png)
...
2. DatagramSocket 常用的一些方法：
    ...
    ![20191018_212938.png](网络编程/rBsADV2pvkyAYdCdAAB0cUg5zxw465.png)
...
3. 此外还需要一个类 DatagramPacket，该类的作用是将数据进行打包。常用方法如下：
    ...
    ![20191018_213001.png](网络编程/rBsADV2pvmSAZXzGAAA2G9G3ynY421.png)
...
6. 改进：
    ...
    ![image-20220204153135000](网络编程/image-20220204153135000.png)

    ![image-20220204153156725](网络编程/image-20220204153156725.png)
...
2. Socket 的常用方法：
    ...
    ![20191018_213250.png](网络编程/rBsADV2pvw6AHmrdAACo1-GXUy0496.png)
...
5. 结果：
    ...
    ![image-20220204160457492](网络编程/image-20220204160457492.png)

    ![image-20220204161830090](网络编程/image-20220204161830090.png)
...
1. 请求样例：
    ...
    ![image-20220213115113266](网络编程/image-20220213115113266.png)
...
3. 用 RecyclerView 将获取到的数据显示出来
    ...
    1. item_get_text.xml：
        ...
        ![image-20220211174252555](网络编程/image-20220211174252555.png)
...
4. 结果显示
    ...
    ![image-20220211175022093](网络编程/image-20220211175022093.png)
...
1. 创建一个按钮控件和一个显示图片的控件 --- activity_pic_load.xml
    ...
    ![image-20220211175339127](网络编程/image-20220211175339127.png)
...
4. 请求样例：
    ...
    ![image-20220213115021562](网络编程/image-20220213115021562.png)
...
3. 请求样例
    ...
    ![image-20220213115001498](网络编程/image-20220213115001498.png)
...
2. 主体格式：
    ...
    ![image-20220213114714398](网络编程/image-20220213114714398.png)

    ![image-20220213114736347](网络编程/image-20220213114736347.png)

    

3. 请求样例：

    ![image-20220213114856405](网络编程/image-20220213114856405.png)
...
2. 主体与主体之间的连接：
    ...
    ![image-20220213114817692](网络编程/image-20220213114817692.png)

3. 请求样例

    ![image-20220213114922965](网络编程/image-20220213114922965.png)
...
1. 请求样例：
    ...
    ![image-20220213162444189](网络编程/image-20220213162444189.png)
...
1. 获取的结果如下：![image-20220215003757371](网络编程/image-20220215003757371.png)
...
1. 服务器接口图：
    ...
    ![image-20220215004001654](网络编程/image-20220215004001654.png)
...
1. 成功返回的结果如下：
    ...
    ![image-20220215004728392](网络编程/image-20220215004728392.png)
...
7. 接口定义：
    ...
    ![image-20220215115532636](网络编程/image-20220215115532636.png)
...
1. 上传结果：![image-20220215114312635](网络编程/image-20220215114312635.png)
...
4. 接口定义：
    ...
    ![image-20220215115508226](网络编程/image-20220215115508226.png)
...
1. 结果：
    ...
    ![image-20220215115417382](网络编程/image-20220215115417382.png)
...
1. 接口：
    ...
    ![image-20220215135417437](网络编程/image-20220215135417437.png)
...
1. 返回的结果：
    ...
    ![image-20220215135716256](网络编程/image-20220215135716256.png)
...
4. activity_main.xml：
    ...
    ![image-20220215161045774](网络编程/image-20220215161045774.png)
...
5. item_json_result.xml：
    ...
    ![image-20220215161159695](网络编程/image-20220215161159695.png)



#### 3. 结果

![image-20220215161531293](网络编程/image-20220215161531293.png)
...
1. 结果截图：
    ...
    ![image-20220218222805633](网络编程/image-20220218222805633.png)
...
1. 结果截图：
    ...
    ![image-20220218223715980](网络编程/image-20220218223715980.png)
...
1. 结果截图：
    ...
    ![image-20220218225308040](网络编程/image-20220218225308040.png)
...
1. 返回结果截图：
    ...
    ![image-20220218231153979](网络编程/image-20220218231153979.png)
...
1. 结果截图：
    ...
    ![image-20220218231848834](网络编程/image-20220218231848834.png)
...
2. 服务器接口方法：
    ...
    ![image-20220218232401747](网络编程/image-20220218232401747.png)
...
1. 结果截图：
    ...
    ![image-20220218232428799](网络编程/image-20220218232428799.png)
...
3. 服务器接口参数：
    ...
    ![image-20220218233255987](网络编程/image-20220218233255987.png)
...
1. 结果截图：
    ...
    ![image-20220218233409215](网络编程/image-20220218233409215.png)
...
1. 结果截图：
    ...
    ![image-20220218233801057](网络编程/image-20220218233801057.png)
...
1. 结果截图：
    ...
    ![image-20220218234430790](网络编程/image-20220218234430790.png)
