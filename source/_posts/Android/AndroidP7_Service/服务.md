...
5. 结果如下：
    ...
    1. 第一次开启服务：
        ...
        ![image-20220118171028265](服务/image-20220118171028265.png)

    2. 第二次开启服务：

        ![image-20220118171118307](服务/image-20220118171118307.png)

    3. 停止服务：

        ![image-20220118171153907](服务/image-20220118171153907.png)
...
3. 具体的代码如下：
    ...
    7. 运行结果
        ...
        ![image-20220118230730294](服务/image-20220118230730294.png)

        绑定服务：

        ![image-20220118230827571](服务/image-20220118230827571.png)

        调用方法：

        ![image-20220118230900509](服务/image-20220118230900509.png)
...
4. activity_third_part_pay.xml：
    ...
    ![image-20220127164824485](服务/image-20220127164824485.png)
...
6. ThirdPartPayClient.activity_main.xml：
    ...
    ![image-20220127164921565](服务/image-20220127164921565.png)
...
1. 创建 MainActivity，写出音乐播放器的前端布局。
    ...
    ![image-20220129164750406](服务/image-20220129164750406.png)
...
1. activity_main.xml：
    ...
    ![image-20220129231923523](服务/image-20220129231923523.png)
