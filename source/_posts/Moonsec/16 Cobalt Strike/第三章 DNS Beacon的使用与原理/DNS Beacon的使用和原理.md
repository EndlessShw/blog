...
![img](DNS Beacon的使用和原理/beepress-image-124454-1583289777.jpg)
...
1. 先在自己的 vps 上添加 A 记录和 NS 记录：
    ...
    ![image-20220120105105320](DNS Beacon的使用和原理/image-20220120105105320.png)
...
4. 添加监听器：
    ...
    ![image-20220120105548412](DNS Beacon的使用和原理/image-20220120105548412.png)

    设置的端口依旧要在防火墙中开放。

    ![image-20220120105706155](DNS Beacon的使用和原理/image-20220120105706155.png)

5. 添加完成后，测试子域名解析是否正常，注意要在防火墙中开放 53 端口，并且协议一定要选择 UDP（DNS 服务器走的是 UDP）

    ![image-20220120105934865](DNS Beacon的使用和原理/image-20220120105934865.png)

    ![image-20220120110318551](DNS Beacon的使用和原理/image-20220120110318551.png)

    c1 下的子域名（包括 c1 本身）都交给了 test 处理

6. 生成 Web 脚本传递：

    ![image-20220120110232277](DNS Beacon的使用和原理/image-20220120110232277.png)

7. 在受害者机器上执行（这里是 win7）

    ![image-20220120110608779](DNS Beacon的使用和原理/image-20220120110608779.png)
